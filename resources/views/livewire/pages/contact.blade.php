                    ...
                    <div class="col-xl-12">
                        <div class="about-banner-content">
                            <h4 class="about-banner-title"
                                ...
                                style="transform:translate3d(0px, 0.01px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(0px, 0.01px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); ">
                    ...
                    <div class="contact-form-left">
                        <div class="contact-form-section-box pb-80">
                            ...
                            <use xlink:href="#image0_2106_35"
                                 transform="translate(-0.425532 -0.170213) scale(0.0212766)"></use>
                            </pattern>
                            ...
                            <p>Skontaktuj się z nami już dziś aby uzyskać niezbędne informacje
                                na temat możliwości współpracy lub realizacji kompleksowego projektu bądź uzyskania
                                wsparcia dla Twojego projektu.</p>
                        </div>
                                ...
                                <div class="row gx-20">
                                    <div class="col-12">
                                        <div class="postbox__comment-input mb-30">
                                            <input type="text" class="inputText" required="" wire:model="form.name">
                                            <span class="floating-label">Imię i nazwisko</span>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="postbox__comment-input mb-30">
                                            <input type="text" class="inputText" required="" wire:model="form.email">
                                            <span class="floating-label">Email</span>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="postbox__comment-input mb-35">
                                            <input type="text" class="inputText" required="" wire:model="form.phone">
                                    ...
                                    <div class="col-xxl-12">
                                        <div class="postbox__comment-input mb-30">
                                            <textarea class="textareaText" required=""
                                    ...
                                    @if(session('success'))
                                        <div class="col-xxl-12">
                                            <div class="postbox__comment-input mb-30 alert alert-success">
                                                {{ session('success') }}
                                            </div>
                                        </div>
                                    @endif
                                    <div class="col-xxl-12">
                                        <div class="postbox__btn-box">
                                            <button class="submit-btn w-100" wire:loading.attr="disabled">
                                                <div wire:loading.inline>
                                                    <x-forms.spinner/>
                                                </div>
                                                <span wire:loading.class="hidden">Wyślij zapytanie</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
