<div>
                    ...
                    <div class="col-xl-12">
                        <div class="about-banner-content">
                            <h4
                                ...
                                style="
                                    transform: translate3d(0px, 0.01px, 0px)
                    ...
                    <div class="contact-form-left">
                        <div class="contact-form-section-box pb-80">
                            ...
                            <p>
                                ...
                                niezbędne informacje na temat możliwości
                                współpracy lub realizacji kompleksowego projektu
                                bądź uzyskania wsparcia dla Twojego projektu.
                            </p>
                        </div>
                        <div class="contact-form-social-box p-relative">
                            ...
                            <div class="contact-form-section-img">
                                <img
                                    src="img/contact/contact-icon-sm-4.png"
                                    alt=""
                                />
                            </div>
                        </div>
                ...
                <div class="col-xl-7 col-lg-6">
                    <div class="contact-form-right-warp">
                        <div class="postbox__comment-form">
                            <form action="#" class="box" wire:submit="submit">
                                <div class="row gx-20">
                                    <div class="col-12">
                                        <div
                                            class="postbox__comment-input mb-30"
                                        >
                                            <input
                                                type="text"
                                                class="inputText"
                                    ...
                                    <div class="col-12">
                                        <div
                                            class="postbox__comment-input mb-35"
                                        >
                                            <input
                                                type="text"
                                                class="inputText"
                                    ...
                                    @if (session('success'))
                                        <div class="col-xxl-12">
                                            <div
                                                class="postbox__comment-input mb-30 alert alert-success"
                                            >
                                                {{ session('success') }}
                                            </div>
                                        </div>
                ...
                <div class="col-xl-12">
                    <div class="contact-inner-title-sm-wrap text-center mb-50">
                        <h4 class="contact-inner-title-sm">
                            Zarezerwuj nasze usługi!
                        </h4>
                        <p>
                            Skontaktujemy się po otrzymaniu zapytania w ciągu 24
                            godzin
                        </p>
                    </div>
                </div>
            ...
            <div class="contact-inner-wrapper">
                <div class="row gx-0">
                    <div class="col-xl-4 col-lg-4">
                        <div
                            class="contact-inner-item d-flex align-items-center justify-content-center"
                        >
                            <div class="contact-inner-img contact-img-1">
                                <img
                                    src="img/contact/contact-icon-sm-1.png"
                                    alt=""
                                />
                            </div>
                            <div class="contact-inner-link">
                                <a href="mailto:contact@softuch.com">
                                    biuro@haajt.pl
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        ...
                        >
                            <div class="contact-inner-img contact-img-2">
                                <img
                                    src="img/contact/contact-icon-sm-2.png"
                                    alt=""
                                />
                            </div>
                            <div class="contact-inner-link">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        ...
                        >
                            <div class="contact-inner-img contact-img-3">
                                <img
                                    src="img/contact/contact-icon-sm-3.png"
                                    alt=""
                                />
                            </div>
                            <div class="contact-inner-link">
                ...
                <div class="col-xl-12 col-lg-12 mb-30">
                    <div class="contact-info-item p-relative">
                        ...
                        <div class="contact-info-img">
                            <img
                                src="img/contact/contact-icon-sm-6.png"
                                alt=""
                            />
                        </div>
    ...
    <!-- tp-cta-area-start -->
    <div class="tp-cta-area p-relative mb-80">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div
                    ...
                    >
                        <div class="tp-cta-content tp-inner-font text-center">
                            ...
                            <p>
                                Eyerything you need to accept cord payments and
                                grow your business
                                <br />
                                anywhere on the planet.
                            </p>
                            <a
                                class="tp-btn-inner white-bg text-black"
